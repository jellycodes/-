...
public class PostController {
	...
	public ResponseEntity<?> selectPost(@RequestBody Post.Request req){
		
		Post findPost = postRepository.findByPostId(req.getPostId());
		
		Post.Response dto = Post.Response.toResponse(findPost);
		
		Post.Response res = Post.Response.builder()
