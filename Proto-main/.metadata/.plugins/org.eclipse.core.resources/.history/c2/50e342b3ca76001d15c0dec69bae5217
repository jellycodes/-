...
private final CommentService commentService;
	...
	public ResponseEntity<?> updateComment(@Valid @RequestBody Comment.Request req, @PathVariable Long commentId){
		commentService.updateComment(req, commentId);
		Comment updatedComment = commentRepository.findByCommentId(commentId);
