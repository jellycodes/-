      ...
      <div className="hidden text-xl md:ml-10 md:block md:space-x-8 md:mr-10">
        ...
        <div className="pt-6 text-sm text-right">
          ...
          <div className="flex items-center flex-shrink-0">
              <Link href="/job/BoardList" className="inline-flex items-center justify-center px-4 py-2 ml-10 mr-3 text-4xl font-extrabold text-gray-200 bg-transparent border border-transparent rounded-full shadow-sm whitespace-nowrap hover:bg-transparent hover:text-gray-600">
                직업
              </Link>
          </div>
