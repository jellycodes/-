           ...
           <form>
                <div className='max-w-2xl px-6 py-10 m-auto bg-gray-300 rounded-md bg-opacity-20'>
                    ...
                    <div className="mb-6 text-xl font-bold text-left text-gray-100 border-none">
                        <Link href="/board-category/BoardList" className='text-gray-100'>
                            잡담 &raquo;
                        </Link>
                    </div>
                    ...
                    {/* 삭제 후 목록으로 갔을 때 새로고침 하지 않아도 적용되도록 고치기 */}
                    <Link href='/'>
                        <button type='delete' onClick={handleDelete} className='float-right px-5 py-2 font-bold border-2 rounded-lg text-neutral-100 hover:bg-sky-300'>Delete</button>
                    </Link>
                    <Link href='/board-category/BoardDetail'>
                        <button type='modify' onClick={handleModify} className='float-right px-5 py-2 font-bold border-2 rounded-lg text-neutral-100 hover:bg-sky-300'>Modify</button>
                    </Link>
