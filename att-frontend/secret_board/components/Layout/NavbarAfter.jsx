        ...
        <nav className="bg-violet-900">
          ...
          --> */}
                        <div className="items-center justify-end hidden md:flex md:flex-1 lg:w-0">
                            <Link href="/users/UserInfo" className="block px-3 py-2 text-base font-bold text-gray-300 rounded-md hover:bg-pink-300 hover:text-white">
                                {/* Nickname 불러오는 것으로 추후 변경해보기 */}
                                My Page
                            </Link>
            ...
            <div className="sm:hidden" id="mobile-menu">
                <div className="px-2 pt-2 pb-3 space-y-1">
                    ...
                    <Link href="/users/UserInfo" className="block px-3 py-2 font-bold text-center text-gray-300 rounded-md hover:bg-pink-300 hover:text-white hover:font-extrabold">Login</Link>

                    <Link href="/Main" onClick={logOut} className="block px-3 py-2 font-bold text-center text-gray-300 rounded-md hover:bg-pink-300 hover:text-white hover:font-extrabold">Logout</Link>
                </div>
            </div>
        </nav >
    )
