      ...
      <form>
        <div className='max-w-2xl px-6 py-10 m-auto bg-white rounded-md'>
          ...
          <Link href='/board-category/BoardList'>
            <button type='create' onClick={handleCreate} className='float-right px-5 py-2 font-bold border-2 rounded-lg border-sky-500 text-blue-500 hover:bg-neutral-200'>등록</button>
          </Link>
