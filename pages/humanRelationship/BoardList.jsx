    ...
    <>
      ...
      <div className="overflow-x-auto mt-6">
            ...
            {boards && boards.slice(offset, offset + limit).map(board => (
              <tr key={board.postId} className="hover:bg-gray-100 border-b border-gray-200 py-10" >
                ...
                <td className="px-4 py-2 text-left border">
                  <Link href="/humanRelationship/BoardDetail" onClick={() => {
        ...
        <BoardPaging
          ...
          setPage={setPage}
        />
        <Link href="/humanRelationship/WriteBoard" onClick={checkUser} className="float-right px-5 py-2 font-bold border-2 rounded-lg text-neutral-900 hover:bg-neutral-200">글쓰기</Link>
      </div>
    </>
  )
}
