...
const Navbar = () => {
      ...
      <div className="relative flex items-center justify-between h-16">
        ...
        <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
          ...
          --> */}
            ...
            <Link href="/member/Login" className="block px-3 py-2 text-base font-bold text-gray-300 rounded-md hover:bg-pink-300 hover:text-white">
              Login
            </Link>
            {/* <Link href="/member/Join" className="inline-flex items-center justify-center px-4 py-2 ml-3 mr-3 text-base font-bold text-gray-300 border border-transparent rounded-md shadow-sm whitespace-nowrap bg-violet-500 hover:bg-indigo-700 hover:text-white">
              Join
            </Link> */}
          </div>
          </div>
  ...
  <div className="sm:hidden" id="mobile-menu">
    <div className="px-2 pt-2 pb-3 space-y-1">
      ...
      <Link href="/SignIn" className="block px-3 py-2 font-bold text-center text-gray-300 rounded-md hover:bg-pink-300 hover:text-white hover:font-extrabold">Login</Link>
          
      {/* <Link href="/Join" className="block px-3 py-2 font-bold text-center text-gray-300 rounded-md hover:bg-pink-300 hover:text-white hover:font-extrabold">Join</Link> */}
    </div>
  </div>
</nav >
  )
