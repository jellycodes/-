      ...
      <div className="relative flex h-16 items-center justify-between">
        ...
        <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
          ...
          --> */}
            ...
            <Link href="/auth/SignIn" className="ml-3 mr-3 inline-flex items-center justify-center whitespace-nowrap rounded-xl border border-transparent bg-violet-500 px-4 py-2 text-base font-bold text-gray-300 shadow-sm hover:bg-indigo-700">
              Join
            </Link>
          </div>
          </div>
