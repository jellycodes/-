...
const Main = () => {
  return (
    <div>
      ...
      // </div> */}
         {/* <div class="bg-[url('/images/1.jpg')]"></div> */}
           {/* <div class="flex justify-center items-center min-h-screen text-xl font-extrabold ...">
        //     <span class="bg-clip-text bg-text-center text-transparent bg-gradient-to-r from-pink-500 to-violet-500">
        //       오늘 하루 어땠나요?<br/>털어놓기 힘든 고민 때문에 힘겨웠나요?<br/> 그렇다면 당신의 고민을 글로 적어보세요.<br/> 혼자 애쓰지 않아도 괜찮아요.<br/> 들어줄게요 당신이 괜찮아질 때까지.<br/> 뜻밖의 위로가 기다리고 있을 지도 몰라요.
        //     </span>
        //   </div> */}
       {/* <div class="lg:w-full w-full bg-blue-0">
      //  <div class="xxx_imgWrap flex flex-col my-auto items-center mx-3">
